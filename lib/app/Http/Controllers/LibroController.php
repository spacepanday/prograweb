...
class LibroController extends Controller
{
    ...
    {
        //
        $libro=Libro::orderBy('id','DESC')->paginate(3);
    ...
    {
        //
        $this->validate($request,[ 'titulo'=>'required', 'imagen'=>'required', 'idautor'=>'required', 'ideditorial'=>'required', 'idcategoria'=>'required', 'idestadolibro'=>'required']);
